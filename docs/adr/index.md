...
- [Use profile-governed architecture decisions](0001-use-profile-governed-architecture-decisions.md) - Keep durable Shikumi decisions in a flat OKF bundle with stable ADR handles and strict profile validation.
