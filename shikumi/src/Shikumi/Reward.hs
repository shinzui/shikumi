...
-- to build one.
--
-- A t'Reward' returns a plain 'Double' (higher is better; by convention in @[0, 1]@
...
-- consume it ("Shikumi.Refine") are first-class t'Shikumi.Program.Program' values
...
-- @shikumi-eval@ @Metric@ derives a t'Reward' from it with the one-line
